...
export default function App() {
  ...
  useEffect(() => {
    // Handle token from URL (cross-domain auth from landing page)
    handleTokenFromUrl()
    loadInfo()
  ...
  function handleTokenFromUrl() {
    ...
    if (urlToken) {
      // Store token from landing page redirect
      ...
      // Refresh user data
      api.getCurrentUser().then(userData => setUser(userData)).catch(() => {})
    }
  }
  ...
  // Navigate to landing/theory page on main domain
  function handleShowTheory() {
    window.location.href = 'https://dream-engine.space'
  }
