          ...
          {mode === 'register' && (
            <>
              <label className="checkbox-label">
                ...
                <span>
                  I agree to the{' '}
                  <a href="https://dream-engine.space/terms" target="_blank" rel="noopener noreferrer">Terms of Service</a>
                  {' '}and{' '}
                  <a href="https://dream-engine.space/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>
                </span>
              </label>
              <div className="auth-buttons">
