...
class DatabaseConfig:
    ...
    host: str = field(default_factory=lambda: os.environ.get('POSTGRES_HOST', 'localhost'))
    database: str = field(default_factory=lambda: os.environ.get('POSTGRES_DB', 'semantic'))
    user: str = field(default_factory=lambda: os.environ.get('POSTGRES_USER', 'postgres'))
    password: str = field(default_factory=lambda: os.environ.get('POSTGRES_PASSWORD', 'postgres'))
